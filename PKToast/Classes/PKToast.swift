...
public class PKToast {
    ...
    //MARK:-
    public static var shared = PKToast()
    ...
    //MARK:- Public Methods
    //MARK:-
    public func show(message: String, animated: Bool = true, presentDuration: Double = 2.0, inViewController: UIViewController? = nil) {
        ...
        if let viewController = inViewController {
            ...
            self.presentingInView = UIApplication.shared.delegate!.window!
        }
